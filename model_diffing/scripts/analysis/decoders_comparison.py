...
# def vis(cc: crosscoder.BaseCrosscoder[Any]):
#     n_models, n_hookpoints = cc.crosscoding_dims
#     for hookpoint_idx in range(n_hookpoints):
#         W_dec_a_LD = cc.W_dec_LXoDo[:, 0, hookpoint_idx]
#         W_dec_b_LD = cc.W_dec_LXoDo[:, 1, hookpoint_idx]
