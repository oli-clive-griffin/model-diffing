...
from model_diffing.utils import calculate_reconstruction_loss_summed_norm_MSEs, sparsity_loss_l1_of_norms
...
class L1CrosscoderTrainer(BaseModelHookpointTrainer[L1TrainConfig, ReLUActivation]):
    def _calculate_loss_and_log(
        ...
        sparsity_loss = sparsity_loss_l1_of_norms(
            W_dec_LTMPD=self.crosscoder.W_dec_LXD[:, None],
            latents_BL=train_res.latents_BL,
        )
