...
class TopKStyleTrainer(
    ...
    def __init__(
        ...
        crosscoder: AcausalCrosscoder[BatchTopkActivation | GroupMaxActivation | TopkActivation],
        wandb_run: Run,
        device: torch.device,
        hookpoints: list[str],
        save_dir: Path | str,
    ...
    def aux_loss(self, batch_BMPD: torch.Tensor, train_res: AcausalCrosscoder.ForwardResult) -> torch.Tensor:
        ...
        return aux_loss(
            ...
            error_BXD=batch_BMPD - train_res.recon_acts_BXD,
        )
